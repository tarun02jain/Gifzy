...
const Gif = ({gif,hover=true}) => {
  return (
    ...
    <div className='w-full mb-2 relative cursor-pointer group aspect-video'>
      ...
      {hover && (
        <div className='absolute inset-0 rounded  opacity-0 group-hover:opacity-100 flex items-end gap-3 p-2  bg-gradient-to-b from-transparent via-transparent to-black font-bold'>
          <img 
